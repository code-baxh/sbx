...
<html>
  ...
  <body ng-app="starter" ng-controller="AppCtrl" style="background: #fff;">
    ...
    <script src="../themes/landing4/js/index.bundle.js"></script>
    <script src="../themes/landing4/js/vendor.bundle.js"></script>
    <script>/* Add your custom javascript  here */</script>
